...
import { getTypeDefinition } from '../../vscode-api/languages/definitions.js'
...
export async function execute(
  ...
  const defs = await getTypeDefinition(args.filePath, args.line, args.character)
...
export function registerGoToTypeDefinition(server: McpServer): void {
